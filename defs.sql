...
CREATE TABLE IF NOT EXISTS `InfResp_POP3` (
   ...
   `Mail_ENGINE` varchar(20) NOT NULL default 'pop3'
) ENGINE=InnoDB CHARACTER SET utf8;
-- End command --
...
CREATE TABLE IF NOT EXISTS `InfResp_Bouncers` (
   ...
   `mailbox` varchar(255) NOT NULL default 'INBOX',
   `mailENGINE` varchar(20) NOT NULL default 'pop3',
...
-- Start command --
ALTER TABLE  `InfResp_responders` ADD  `OptOutDisplayRedir` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER  `OptOutDisplay`;
-- End command --

-- Start command --
ALTER TABLE  `InfResp_responders` ADD  `OptInDisplayRedir` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER  `OptInDisplay`;
-- End command --
