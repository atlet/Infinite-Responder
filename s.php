    ...
    if (($action == "sub") || ($action == "subscribe") || ($action == "s")) {
        ...
        if (mysql_num_rows($result) > 0) {
            ...
            if ($DB_Confirmed == "1") {
                ...
                # Display from the DB or the template OR redirect
                if ((trim($DB_OptInDisplayRedir)) != "") {
                    if ($SilentMode != 1) {
                        header("Location: $DB_OptInDisplayRedir");
                        print "<br>\n";
                        print "Now redirecting you to a new page...<br>\n";
                        print "<br>\n";
                        print "If your browser doesn't support redirects then you'll need to <A HREF=\"$DB_OptInDisplayRedir\">click here.</A><br>\n";
                        print "<br>\n";
                    }
                    die();
                } else {
