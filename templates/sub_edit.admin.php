...
<table border="0" width="650" cellspacing="5" cellpadding="0" bgcolor="#660000" style="border: 1px solid #000000;">
   <tr>
      <td>
...
<table border="0" width="650" cellspacing="5" cellpadding="0" bgcolor="#CCCCCC" style="border: 1px solid #000000;">
   <tr>
   ...
   <tr>
      ...
      <td width="500"><input name="firstname" size=50 maxlength=100 value="<?php echo $DB_FirstName; ?>" class="fields"></td>
   </tr>
   <tr>
      <td width="150"><strong>Last Name:</strong></td>
      <td width="500"><input name="lastname" size=50 maxlength=100 value="<?php echo $DB_LastName; ?>" class="fields"></td>
   </tr>
   <tr>
      <td width="150"><strong>Email Addy:</strong></td> 
      <td width="500"><input name="email_addy" size=50 maxlength=100 value="<?php echo $DB_EmailAddress; ?>" class="fields"></td>
   </tr>
   <tr><td colspan="2"><hr style="border: 0; background-color: #660000; color: #660000; height: 1px; width: 100%;"></td></tr>
   <tr>
   ...
   <tr>
      ...
      <td width="500"><input name="ReferralSource" size=50 maxlength=99 value="<?php echo $DB_ReferralSource; ?>" class="fields"></td>
   </tr>
   <tr>
      <td width="150"><strong>Unique Code:</strong></td> 
      <td width="500"><input name="UniqueCode" size=50 maxlength=99 value="<?php echo $DB_UniqueCode; ?>" class="fields"></td>
   </tr>
   <tr><td colspan="2"><hr style="border: 0; background-color: #660000; color: #660000; height: 1px; width: 100%;"></td></tr>
   <tr>
      <td width="150">
