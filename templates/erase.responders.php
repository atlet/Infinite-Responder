...
<center>
   ...
   <table width="750" bgcolor="#CCCCCC" style="border: 1px solid #000000;">
      ...
      <tr>
         <td width="250"><font size=4 color="#000066">Opt-In Confirmation page Redirect: </font><br></td>
         <td width="450"><font size=4 color="#003300"><?php echo $DB_OptInDisplayRedir; ?></font><br></td>
      </tr>
      <tr>
