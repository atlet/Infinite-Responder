...
<table width="750"><tr><td> 
  ...
  <table border="0" width="750" border="1" bgcolor="#CCCCCC" cellspacing="0" cellpadding="0" style="border: 1px solid #000000;"><tr><td>
     <center> 
       <table>
       ...
       <tr>
           ...
           <td width="150">
               <center><FORM action="mailbursts.php" method=POST>
                  ...
                  <input type="submit" name="submit" value="Confirm Delete!" alt="Confirm Delete!">
               </FORM></center>
           </td>
       </tr>
       </table> 
