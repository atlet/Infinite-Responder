...
<?php
      ...
      print "</tr> \n";
      print "<tr><td width=\"200\"><strong>Opt-In Confirmation Page Redirect URL:</strong></td> \n";
      print "<td><input name=OptInDisplayRedir size=63 maxlength=100 value=\"$DB_OptInDisplayRedir\" class=\"fields\"></td>\n";
      print "</tr> \n";
