...
<table border="0" width="750" bgcolor="#CCCCCC" style="border: 1px solid #000000;">
   ...
   <tr>
      ...
      <td colspan="2"><input name=pop3_host size=29 maxlength=95 value="<?php echo $DB_POP3_host; ?>" class="fields"></td>
   ...
   <tr>
      ...
      <td colspan="2"><input name=pop3_spam size=29 maxlength=95 value="<?php echo $DB_SpamHeader; ?>" class="fields"></td>
   ...
   <tr>
      ...
      <td colspan="4"><input name=pop3_box size=29 maxlength=95 value="<?php echo $DB_POP3_mailbox; ?>" class="fields"></td>
   </tr>
   <tr><td colspan="5"><hr style="border: 0; background-color: #660000; color: #660000; height: 1px; width: 100%;"></td></tr>
   <tr>
      <td colspan="2"><strong>Username:</strong> &nbsp; <input name=pop3_user size=27 maxlength=95 value="<?php echo $DB_POP3_username; ?>" class="fields"></td>
      <td>&nbsp;</td>
      <td colspan="2"><strong>Password:</strong> &nbsp; <input name=pop3_pw size=27 maxlength=95 value="<?php echo $DB_POP3_password; ?>" class="fields"></td>
   </tr>
   <tr>
      <td colspan="5">
