...
<table width="750" border="0"><tr><td> 
  <table width="750" bgcolor="#660000" style="border: 1px solid #000000;"><tr><td> 
     <p align="center" style="font-size: 200%"> 
        <font color="#FFFFFF"><?php echo $heading; ?></font> 
     </p> 
  </td></tr></table>
  <FORM action="mailbursts.php" method=POST> 
  <table border="0" width="750" bgcolor="#CCCCCC" style="border: 1px solid #000000;"><tr><td> 
     <center> 
       <table>
       <tr><td>
       ...
       <tr><td> 
          ...
          <input name="subj" size=97 maxlength=250 value="<?php echo $subject; ?>" class="fields">
       </td></tr> 
       <tr><td> 
          <br> 
          <strong>Body: Text Version</strong>  &nbsp; &nbsp; &nbsp; &nbsp; -- <em>[Try copy and paste]</em><br> 
          <textarea name="bodytext" rows=10 cols=95 class="text_area"><?php echo $text_msg; ?></textarea> 
       </td></tr> 
       <tr><td> 
          <br> 
          <strong>Body: HTML Version</strong> &nbsp; &nbsp; &nbsp; &nbsp; -- <em>[Try copy and paste]</em><br> 
          <textarea name="bodyhtml" rows=14 cols=95 class="html_area"><?php echo $html_msg; ?></textarea> 
       </td></tr>
       <tr><td colspan=2>
