...
<table border="0" cellspacing="2" cellpadding="0" width="750" bgcolor="#CCCCCC" style="border: 1px solid #000000;">
   ...
   <tr>
      ...
      <td width="200">
         <input name="EmailAddy" size=20 maxlength=250 value="<?php echo $data['EmailAddy']; ?>" class="fields">
      </td>
      <td width="155">
   ...
   <tr>
      ...
      <td width="200">
         <input name="username" size=20 maxlength=250 value="<?php echo $data['username']; ?>" class="fields">
      </td>
      <td width="155">
         <strong>Password:</strong>
      </td>
      <td width="200">
         <input name="password" size=20 maxlength=250 value="<?php echo $data['password']; ?>" class="fields">
      </td>
   </tr>
   <tr>
      <td width="175">
   ...
   <tr>
      ...
      <td width="200">
         <input name="SpamHeader" size=20 maxlength=250 value="<?php echo $data['SpamHeader']; ?>" class="fields">
      </td>
   </tr>
   <tr>
      <td colspan="4">
