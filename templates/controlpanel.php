...
<table border="0" width="760" cellpadding="2" cellspacing="0" class="cp_table">
  <tr>
    ...
    <td colspan="4">
       <table width="100%" cellpadding="0" cellspacing="0" border="0" class="cp_table"><tr><td>
          <form action="admin.php" method=POST> 
...
<table align="right" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td>
       <center><a href="manual.html#<?php echo $help_section; ?>" onclick="return popper('manual.html#<?php echo $help_section; ?>')">Help</a></center>
    </td>
    <td width="50">&nbsp;</td>
    <td>
